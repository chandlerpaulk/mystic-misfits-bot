    ...
    if (type === InteractionType.APPLICATION_COMMAND) {
      ...
      const actions = {
        ...
        mine: [
          ...
          { name: 'stone', tier: 'Common', chance: 0.225, min: 1, max: 3, value: 5 },
          { name: 'copper', tier: 'Uncommon', chance: 0.225, min: 1, max: 3, value: 7 },
          { name: 'iron', tier: 'Uncommon', chance: 0.15, min: 1, max: 2, value: 10 },
          { name: 'silver', tier: 'Uncommon', chance: 0.15, min: 1, max: 2, value: 12 },
          { name: 'gold', tier: 'Rare', chance: 0.075, min: 1, max: 1, value: 20 },
          { name: 'platinum', tier: 'Rare', chance: 0.075, min: 1, max: 1, value: 22 },
          { name: 'diamond', tier: 'Epic', chance: 0.035, min: 1, max: 1, value: 100 },
          { name: 'ruby', tier: 'Epic', chance: 0.035, min: 1, max: 1, value: 110 },
          { name: 'emerald', tier: 'Legendary', chance: 0.01, min: 1, max: 1, value: 200 },
          { name: 'sapphire', tier: 'Legendary', chance: 0.01, min: 1, max: 1, value: 210 },
        ...
        chop: [
          ...
          { name: 'ancient oak', tier: 'Legendary', chance: 0.02, min: 1, max: 5, value: 50 },
